...
//go:generate minimock -i route256/cart/internal/usecases/cart.lomsClient -o loms_client_mock_test.go -n LomsClientMock -p cart
...
type LomsClientMock struct {
	...
	funcOrderCreate          func(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item) (orderID int64, err error)
	funcOrderCreateOrigin    string
	inspectFuncOrderCreate   func(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item)
...
func (mmOrderCreate *mLomsClientMockOrderCreate) Expect(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item) *mLomsClientMockOrderCreate {
	...
	mmOrderCreate.defaultExpectation.params = &LomsClientMockOrderCreateParams{ctx, u1, ia1}
...
// ExpectU1Param2 sets up expected param u1 for lomsClient.OrderCreate
func (mmOrderCreate *mLomsClientMockOrderCreate) ExpectU1Param2(u1 cartDto.UserID) *mLomsClientMockOrderCreate {
	if mmOrderCreate.mock.funcOrderCreate != nil {
		mmOrderCreate.mock.t.Fatalf("LomsClientMock.OrderCreate mock is already set by Set")
	}
	...
	mmOrderCreate.defaultExpectation.paramPtrs.u1 = &u1
	mmOrderCreate.defaultExpectation.expectationOrigins.originU1 = minimock.CallerInfo(1)

	return mmOrderCreate
}

// ExpectIa1Param3 sets up expected param ia1 for lomsClient.OrderCreate
func (mmOrderCreate *mLomsClientMockOrderCreate) ExpectIa1Param3(ia1 []cartDto.Item) *mLomsClientMockOrderCreate {
	if mmOrderCreate.mock.funcOrderCreate != nil {
		mmOrderCreate.mock.t.Fatalf("LomsClientMock.OrderCreate mock is already set by Set")
	}
	...
	mmOrderCreate.defaultExpectation.paramPtrs.ia1 = &ia1
	mmOrderCreate.defaultExpectation.expectationOrigins.originIa1 = minimock.CallerInfo(1)

	return mmOrderCreate
}

// Inspect accepts an inspector function that has same arguments as the lomsClient.OrderCreate
func (mmOrderCreate *mLomsClientMockOrderCreate) Inspect(f func(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item)) *mLomsClientMockOrderCreate {
...
func (mmOrderCreate *mLomsClientMockOrderCreate) Set(f func(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item) (orderID int64, err error)) *LomsClientMock {
	if mmOrderCreate.defaultExpectation != nil {
...
// Then helper
func (mmOrderCreate *mLomsClientMockOrderCreate) When(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item) *LomsClientMockOrderCreateExpectation {
	if mmOrderCreate.mock.funcOrderCreate != nil {
		mmOrderCreate.mock.t.Fatalf("LomsClientMock.OrderCreate mock is already set by Set")
	}
	...
	expectation := &LomsClientMockOrderCreateExpectation{
		...
		params:             &LomsClientMockOrderCreateParams{ctx, u1, ia1},
...
func (mmOrderCreate *LomsClientMock) OrderCreate(ctx context.Context, u1 cartDto.UserID, ia1 []cartDto.Item) (orderID int64, err error) {
	...
	if mmOrderCreate.inspectFuncOrderCreate != nil {
		mmOrderCreate.inspectFuncOrderCreate(ctx, u1, ia1)
	}

	mm_params := LomsClientMockOrderCreateParams{ctx, u1, ia1}
	...
	if mmOrderCreate.OrderCreateMock.defaultExpectation != nil {
		...
		mm_got := LomsClientMockOrderCreateParams{ctx, u1, ia1}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.u1 != nil && !minimock.Equal(*mm_want_ptrs.u1, mm_got.u1) {
				mmOrderCreate.t.Errorf("LomsClientMock.OrderCreate got unexpected parameter u1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmOrderCreate.OrderCreateMock.defaultExpectation.expectationOrigins.originU1, *mm_want_ptrs.u1, mm_got.u1, minimock.Diff(*mm_want_ptrs.u1, mm_got.u1))
			}

			if mm_want_ptrs.ia1 != nil && !minimock.Equal(*mm_want_ptrs.ia1, mm_got.ia1) {
				mmOrderCreate.t.Errorf("LomsClientMock.OrderCreate got unexpected parameter ia1, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmOrderCreate.OrderCreateMock.defaultExpectation.expectationOrigins.originIa1, *mm_want_ptrs.ia1, mm_got.ia1, minimock.Diff(*mm_want_ptrs.ia1, mm_got.ia1))
			}
	...
	if mmOrderCreate.funcOrderCreate != nil {
		return mmOrderCreate.funcOrderCreate(ctx, u1, ia1)
	}
	mmOrderCreate.t.Fatalf("Unexpected call to LomsClientMock.OrderCreate. %v %v %v", ctx, u1, ia1)
	return
}
...
func (mmStocksInfo *mLomsClientMockStocksInfo) Expect(ctx context.Context, sku int64) *mLomsClientMockStocksInfo {
...
func (mmStocksInfo *mLomsClientMockStocksInfo) ExpectSkuParam2(sku int64) *mLomsClientMockStocksInfo {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsClientMock.StocksInfo mock is already set by Set")
	}
...
func (mmStocksInfo *mLomsClientMockStocksInfo) Inspect(f func(ctx context.Context, sku int64)) *mLomsClientMockStocksInfo {
...
func (mmStocksInfo *mLomsClientMockStocksInfo) Return(u1 uint32, err error) *LomsClientMock {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsClientMock.StocksInfo mock is already set by Set")
	}
...
func (mmStocksInfo *mLomsClientMockStocksInfo) Set(f func(ctx context.Context, sku int64) (u1 uint32, err error)) *LomsClientMock {
	if mmStocksInfo.defaultExpectation != nil {
...
// Then helper
func (mmStocksInfo *mLomsClientMockStocksInfo) When(ctx context.Context, sku int64) *LomsClientMockStocksInfoExpectation {
	if mmStocksInfo.mock.funcStocksInfo != nil {
		mmStocksInfo.mock.t.Fatalf("LomsClientMock.StocksInfo mock is already set by Set")
	}
...
func (e *LomsClientMockStocksInfoExpectation) Then(u1 uint32, err error) *LomsClientMock {
...
func (mmStocksInfo *LomsClientMock) StocksInfo(ctx context.Context, sku int64) (u1 uint32, err error) {
